        ...
        <Fragment>
          <div className="box">
            ...
            <div className="level">
              ...
              <div>
                <button className="button is-primary" onClick={() => this.saveCredit(this.state.modalUser, this.state.creditFormNote, this.state.creditFormAmount)}><Translate id="save" /></button>
              </div>
            </div>
          </div>
        </Fragment>
