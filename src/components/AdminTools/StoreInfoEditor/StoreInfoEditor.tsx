...
export default class StoreInfoEditor extends Component<Props, State> {
  ...
  onFilesDrop = async (files: any) => {
    ...
    firebase.set(`/${filesPath}/${files[0].lastModified}${files[0].size}`, {
      name: files[0].name,
      downloadURL,
    });
    return result;
  ...
  todaysOpeningHours() {
        ...
        return (
          <div className="box">
            <span className="has-text-danger">
              <FormattedMessage id="exceptionallynotopentoday" />
            </span>
            : {exception.name}
          </div>
        );
      ...
      return (
        <div className="box">
          <span className="has-text-success">
            <FormattedMessage id="exceptionallyopentoday" />
          </span>
    ...
    return (
      <div className="box">
        ...
        <span className="has-text-success">{todaysHours}</span>
      </div>
    );
  }
  ...
  toggleOpeningHourExceptions() {
    this.setState((prevState) => ({
      openingHoursExceptionEditorOpen: !prevState.openingHoursExceptionEditorOpen,
    }));
  }
      ...
      return (
        <>
          ...
          <div className="box">
            ...
            <div className="level">
              ...
              <div className="level-right">
                <button
                  onClick={() => {
                    firebase.update("/settings/features/storeinfo/", {
                      introtext: true,
                    });
                  }}
                  className={`button ${introTextActive && "is-success"}`}
                >
                ...
                <button
                  ...
                  className={`button ${!introTextActive && "is-danger"}`}
                >
          ...
          <OpeningHoursEditor
            ...
            toggleOpeningHourExceptions={() =>
              this.toggleOpeningHourExceptions()
            }
          />
          <div className="box">
            <OpeningHours
          ...
          {this.state.openingHoursExceptionEditorOpen && (
                        ...
                        <td>
                          ...
                          {settings.locationImage !== file.downloadURL && (
                            <button
                              ...
                              onClick={() => this.useAsLocationImage(file)}
                            >
